class CategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @category.save
        format.html { redirect_to articles_path, notice: 'Category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @category.update(category_params)
        format.html { redirect_to articles_path, notice: 'Category was successfully updated.' }
  ...
  private
    ...
    def category_params
      params.require(:category).permit(:name, :html_id)
    end
end
